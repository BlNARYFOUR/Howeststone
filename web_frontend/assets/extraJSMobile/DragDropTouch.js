    ...
    let DragDropTouch = (function () {
        ...
        function DragDropTouch() {
            ...
            if ('ontouchstart' in document) {
                let d = document, ts = this._touchstart.bind(this), tm = this._touchmove.bind(this),
        ...
        DragDropTouch.prototype._touchmove = function (e) {
            if (this._shouldHandle(e)) {
                ...
                if (this._dispatchEvent(e, 'mousemove', target)) {
                    ...
                    // changed next line Mattijs Step
                    // e.preventDefault();
        ...
        DragDropTouch.prototype._createImage = function (e) {
            ...
            if (!this._imgCustom) {
                let rc = src.getBoundingClientRect(), pt = this._getPoint(e);
        ...
        DragDropTouch.prototype._dispatchEvent = function (e, type, target) {
            if (e && target) {
                let evt = document.createEvent('Event'), t = e.touches ? e.touches[0] : e;
